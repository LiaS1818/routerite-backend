import { IsInt, IsString, IsNumber, IsOptional, IsDateString, IsIn, IsNotEmpty } from 'class-validator';
...
export class CreateActivityDto {
  ...
  @IsIn(['walking', 'car', 'bus', 'train', 'plane', 'bicycle'], {
    message: 'Transportation mode must be one of: walking, car, bus, train, plane, bicycle'
  })
